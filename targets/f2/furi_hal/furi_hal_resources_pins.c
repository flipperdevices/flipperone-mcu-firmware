...
const GpioPin gpio_power_led_red = {.pin = 10};
const GpioPin gpio_status_led_dcdc_enable = {.pin = 11};

const GpioPin gpio_display_reset = {.pin = 12};
const GpioPin gpio_display_backlight_en = {.pin = 13};
...
const GpioPin gpio_power_led_green = {.pin = 24};
...
const GpioPin gpio_power_led_blue_dfu = {.pin = 35};
...
const GpioPin gpio_cpu_int = {.pin = 42};

const GpioPin gpio_expander_reset = {.pin = 43};

// uart: logs
const GpioPin gpio_debug_tx = {.pin = 44};

const GpioPin gpio_audio_hp_detect = {.pin = 45};
