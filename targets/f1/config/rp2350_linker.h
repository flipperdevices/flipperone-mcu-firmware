...
extern const void __heap_start__; /**< RAM1 Heap start (alias for FuriHal) */
extern const void __heap_end__; /**< RAM1 Heap end (alias for FuriHal) */
extern const void __heap_size__; /**< RAM1 Heap size = heap_end - heap_start - stack */
