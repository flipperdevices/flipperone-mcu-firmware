...
static Bq28z620Status bq28z620_sub_cmd_read(Bq28z620* instance, Bq28z620SubCmd sub_cmd, Bq28z620SubCmdResponse* response) {
    furi_check(instance);
    ...
    do {
        ...
        //furi_delay_ms(5); // The delay required for the chip to process the request
...
Bq28z620Status bq28z620_get_device_type(Bq28z620* instance, Bq28z620MacSubcmdDeviceTypeRegBits* device_type) {
    ...
    Bq28z620Status status = bq28z620_sub_cmd_read(instance, Bq28z620MacSubcmdDeviceType, &resp);
...
Bq28z620Status bq28z620_get_device_name(Bq28z620* instance, Bq28z620MacSubcmdDeviceNameRegBits* device_name) {
    ...
    Bq28z620Status status = bq28z620_sub_cmd_read(instance, Bq28z620MacSubcmdManufacturerName, &resp);
    if(status == Bq28z620StatusOk) {
...
Bq28z620Status bq28z620_get_operation_status(Bq28z620* instance, Bq28z620MacSubcmdOperationStatusRegBits* operation_status) {
    ...
    Bq28z620Status status = bq28z620_sub_cmd_read(instance, Bq28z620MacSubcmdOperationStatus, &resp);
    if(status == Bq28z620StatusOk) {
...
Bq28z620Status bq28z620_get_chemical_id(Bq28z620* instance, Bq28z620MacSubcmdChemicalIDRegBits* chemical_id) {
    ...
    Bq28z620Status status = bq28z620_sub_cmd_read(instance, Bq28z620MacSubcmdChemID, &resp);
    if(status == Bq28z620StatusOk) {
...
Bq28z620Status bq28z620_get_i2c_configuration(Bq28z620* instance, uint8_t* i2c_configuration) {
    ...
    Bq28z620Status status = bq28z620_sub_cmd_read(instance, 0x4602, &resp);
    if(status == Bq28z620StatusOk) {
...
Bq28z620Status bq28z620_set_i2c_configuration(Bq28z620* instance, uint8_t* i2c_configuration) {
    ...
    uint8_t i2c_config_data[2] = {0x08, 0x00};
    Bq28z620Status status = bq28z620_sub_cmd_write(instance, 0x4602, i2c_config_data, 2);
    if(status == Bq28z620StatusOk) {
        BQ28Z620_DEBUG(TAG, "Set I2C configuration to: 0x%02X 0x%02X ", i2c_config_data[0], i2c_config_data[1]);
    } else {
