...
// Milliseconds until the next PE protocol-timer deadline for the current
// state, or UCSI_PPM_NO_TIMEOUT when the state has no timed transition.
// Backend for ucsi_ppm_next_timeout_ms.
