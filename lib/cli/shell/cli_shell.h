...
/**
 * @brief Frees the pipe provided in `cli_shell_alloc` when the shell exits.
 * 
 * @param [in] shell Shell instance
 */
...
/**
 * @brief Prints a notification while a command is not running
 * 
 * @param [in] shell Shell instance
 * @param [inout] string String to print
 */
